...
def get_mobilenet_v2(multiplier, **kwargs):
    ...
    param_dict = mx.nd.load('/home/checkpoints/0.4548-imagenet-mobilenetv2_1.0-best-0200.params')
    # print(param_dict)
    print(param_dict.keys())
    with net.name_scope():
        net.load_parameters('/home/checkpoints/0.4548-imagenet-mobilenetv2_1.0-best-0200.params')
    return net
