...
def get_mobilenet_v2(multiplier, **kwargs):
    ...
    """
    net = MobileNetV2(multiplier, **kwargs, prefix='')
    #net.load_parameters('./params/0.4963-imagenet-mobilenetv2_1.0-backdoor-0059.params')
    return net
...
net = gluon.nn.SymbolBlock.imports('./params/0.4963-imagenet-mobilenetv2_1.0-backdoor-symbol.json',
                                   ['data'], 
                                   param_file='./params/0.4963-imagenet-mobilenetv2_1.0-backdoor-0059.params',
